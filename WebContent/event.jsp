      ...
      <div class="page-main">
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            ...
            <ul>返回事件信息错误！</ul>            	
            <%}
            //String content=indexdao.def_replace(emperordata.getString("content"));
			%>
            <div class="row">
              ...
              <div class="col-lg-10">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h1 class="mt-4 mb-4"><%= emperordata.getString("title") %></h> 
                  </div>
                    <div class="text-wrap p-lg-6">
                      <h2></h2>
                        <p>
                        	<%= emperordata.getString("content").replace("\n", "<br/>") %>
                      	</p>
                    </div> 
                    <li>来源：<a href='<%= emperordata.getString("source") %>'><%= emperordata.getString("source") %></a>
                    </li>
                  </div>
                </div>
              </div>
